webpackJsonp([4],Array(343).concat([
/* 343 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_api_service_api_service__ = __webpack_require__(212);
...
var ProfilePage = (function () {
    ...
    ProfilePage.prototype.getUser = function (user_id) {
        var _this = this;
        this.api.getUser(this.user_id).subscribe(function (response) {
            _this.usero = response.user;
            console.log(response);
            console.log(_this.usero);
        }, function (error) { console.log(error); });
    };
    ProfilePage.prototype.updateUser = function (user_id) {
        var _this = this;
        var new_user = {
        ...
        __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.auth().currentUser.updateEmail(new_user.email).then(function () {
            _this.api.updateUser(_this.user_id, new_user).subscribe(function (response) {
    ...
    ProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-profile',template:/*ion-inline-start:"/home/db8/Documents/Projects/cl_client/src/pages/profile/profile.html"*/'<!--\n  Generated template for the ProfilePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{usero.name}} {{usero.last_name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n        <form [formGroup]="user" (ngSubmit)="updateUser()" text-center >\n        <ion-row justify-content-center>\n          <ion-col col-10 text-left>\n            <ion-item>\n              <ion-label floating>Email</ion-label>\n              <ion-input type="email" formControlName="email" value="{{usero.email}}"></ion-input>\n            </ion-item>\n          </ion-col>\n          <ion-col col-10 text-left>\n            <ion-item>\n              <ion-label floating>Celular</ion-label>\n              <ion-input type="text" formControlName="phone" value="{{usero.phone}}"></ion-input>\n            </ion-item>\n          </ion-col>\n          <ion-col col-10 text-center margin-top margin-bottom>\n            <button ion-button  color="carlabC" block  type="submit" >\n              Actualizar Datos\n            </button>\n          </ion-col>\n        </ion-row>\n        </form>\n    </ion-row>\n    <!-- <ion-row>\n      <h1>Puntuación</h1>\n    </ion-row>\n    <ion-row justify-content-center>\n      <h1>4.5/5</h1>\n    </ion-row> -->\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/home/db8/Documents/Projects/cl_client/src/pages/profile/profile.html"*/,
        }),
